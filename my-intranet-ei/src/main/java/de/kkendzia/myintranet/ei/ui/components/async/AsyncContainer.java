package de.kkendzia.myintranet.ei.ui.components.async;
...
public class AsyncContainer<T extends Component> extends Composite<Div>
{
    ...
    public AsyncContainer(
            T component,
            BiConsumer<T, UI> componentLoader)
    {
        this();
    ...
    {
        private final UI ui;
        private final AsyncContainer<T> lazyContainer;

        public LoadingThread(
                UI ui,
                AsyncContainer<T> lazyContainer)
        {
            this.ui = ui;
        ...
        public void run()
        {
            ...
            // Remove the spinner
            ui.access(() -> lazyContainer.setLoaded());
        }
    }
}